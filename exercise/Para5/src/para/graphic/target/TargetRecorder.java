...
import static org.bytedeco.opencv.presets.opencv_highgui.*;
...
public class TargetRecorder implements Target {
   ...
   * 確実に終了処理を行うためには、{@link Runtime#addShutdownHook
   * Runtime#addShutdownHook}を利用して、終了処理を登録しておく必要がある。このメソッドではその登録を行う。
   */
